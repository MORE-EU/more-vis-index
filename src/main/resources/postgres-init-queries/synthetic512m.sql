...
SELECT date_part('epoch', timestamp) * 1000, timestamp, value_1, 0, 'value_1' FROM more.synthetic512m_tmp;

INSERT INTO more.synthetic512m(epoch, timestamp, value, id, col)
SELECT date_part('epoch', timestamp) * 1000, timestamp, value_2, 1, 'value_2' FROM more.synthetic512m_tmp;

INSERT INTO more.synthetic512m(epoch, timestamp, value, id, col)
SELECT date_part('epoch', timestamp) * 1000, timestamp, value_3, 2, 'value_3' FROM more.synthetic512m_tmp;

INSERT INTO more.synthetic512m(epoch, timestamp, value, id, col)
SELECT date_part('epoch', timestamp) * 1000, timestamp, value_4, 3, 'value_4' FROM more.synthetic512m_tmp;
