package eu.more2020.visual.index.domain.InfluxDB.InitQueries;
...
import eu.more2020.visual.index.experiments.util.QueryUtils;

import java.text.ParseException;
import java.time.Instant;

@Measurement(name = "synthetic512m")
public class SYNTHETIC512M {
