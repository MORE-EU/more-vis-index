...
//
//public class _MinMaxCache {
//
//    private static final Logger LOG = LoggerFactory.getLogger(_MinMaxCache.class);
//
...
//     * @param dataset
//     */
//    public _MinMaxCache(AbstractDataset dataset, double prefetchingFactor, int aggFactor, int dataReductionRatio) {
//        this.dataset = dataset;
//        this.dataSource = DataSourceFactory.getDataSource(null, dataset);
...
//        }
//        List<MaxErrorEvaluator.MissingRange> missingIntervals = maxErrorEvaluator.getMissingRanges();
