...
public class InfluxDBDataPointsIteratorMulti implements Iterator<DataPoint> {
    ...
    public InfluxDBDataPointsIteratorMulti(List<TimeInterval> ranges, List<List<String>> measures, List<FluxTable> tables) {
