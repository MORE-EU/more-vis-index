...
public class InfluxDBAggregateDataPointsIteratorM4Multi implements Iterator<AggregatedDataPoint> {

    private static final Logger LOG = LoggerFactory.getLogger(InfluxDBAggregateDataPointsIteratorM4Multi.class);
    ...
    public InfluxDBAggregateDataPointsIteratorM4Multi(List<List<String>> measureNames, List<List<Integer>> measures, List<FluxTable> tables, Integer numberOfGroups) {
    ...
    private AggregatedDataPoint createAggregatedDataPoint() {
        StatsAggregator statsAggregator = new StatsAggregator(measures.get(currentTable));
