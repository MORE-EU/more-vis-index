...
public class ModelarDBDatasource implements DataSource {
    ...
    @Override
    public AggregatedDataPoints getAggregatedDataPoints(long from, long to, List<TimeInterval> timeIntervals, List<List<Integer>> measures, QueryMethod queryMethod, int numberOfGroups) {
        return null;
    }
