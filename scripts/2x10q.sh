...
-viewport 1000,600 -runs 1 -out 80a2x10q -minShift 0.1 -maxShift 1 -schema more -table \
...
java -jar target/experiments.jar -c timeQueries -seqCount 25 -type influx -mode all -measures 2 -timeCol datetime -zoomFactor 1.4 \
-viewport 1000,600 -runs 1 -out 90a2x10q -minShift 0.1 -maxShift 1 -schema more -table \
...
java -jar target/experiments.jar -c timeQueries -seqCount 25 -type influx -mode all -measures 2 -timeCol datetime -zoomFactor 1.4 \
-viewport 1000,600 -runs 1 -out 95a2x10q -minShift 0.1 -maxShift 1 -schema more -table \
