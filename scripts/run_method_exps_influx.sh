...
# sh scripts/run.sh 0.95 0.01 1 8 6 influx
# sh scripts/run.sh 0.95 0.05 1 8 6 influx
# sh scripts/run.sh 0.95 0.1 1 8 6 influx
# sh scripts/run.sh 0.95 0.5 1 8 6 influx


 sh scripts/run.sh 0.95 0.01 1 16 6 influx
 sh scripts/run.sh 0.95 0.05 1 16 6 influx
 sh scripts/run.sh 0.95 0.1 1 16 6 influx
 sh scripts/run.sh 0.95 0.5 1 16 6 influx
