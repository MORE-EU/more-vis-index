...
java -jar ../target/experiments.jar -path /data/data2/bstam/more-vis/real_exp/intel_lab.csv -c timeQueries -seqCount 50 -type influx \
...
java -jar ../target/experiments.jar -path /data/data2/bstam/more-vis/real_exp/soccer.csv -c timeQueries -seqCount 50 -type influx \
-measures 3,4 -timeCol datetime -zoomFactor 2 -out output -minShift 0.01 -maxShift 1 \
...
java -jar ../target/experiments.jar -path /data/data2/bstam/more-vis/real_exp/manufacturing.csv -c timeQueries -seqCount 50 -type influx \
-measures 3,4 -timeCol datetime -zoomFactor 2 -out output -minShift 0.01 -maxShift 1 \
