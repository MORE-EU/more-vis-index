...
-startTime "2013-02-20 09:00:00.000" -endTime "2114-02-19 02:17:00.000"  \
...
java -jar ../target/experiments.jar -c timeQueries -a 0.1 -seqCount 50 -type influx \
-measures 3,4 -timeCol datetime -zoomFactor 0.5 -out output -minShift 0.01 -maxShift 1 \
-startTime "1975-06-20 07:22:00.000" -endTime "1976-01-14 10:54:00.000" \
...
java -jar ../target/experiments.jar -c timeQueries -a 0.1 -seqCount 50 -type influx \
-measures 3,4 -timeCol datetime -zoomFactor 0.5 -out output -minShift 0.01 -maxShift 1 \
-startTime "2012-02-24 23:42:11.000" -endTime "2012-02-25 05:15:00.000" \
